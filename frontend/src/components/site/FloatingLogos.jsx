...
const MARKS = [
  { x: 6, y: 22, size: 30, o: 0.22, color: "#9D7BFF", dur: 6, delay: 0, type: "s" },
  ...
  { x: 30, y: 84, size: 24, o: 0.18, color: "#9D7BFF", dur: 6.5, delay: 1.6, type: "s" },
  ...
  { x: 58, y: 24, size: 28, o: 0.2, color: "#9D7BFF", dur: 6, delay: 0.4, type: "s" },
  { x: 64, y: 78, size: 16, o: 0.14, color: "#5AA9FF", dur: 5.8, delay: 1.3, type: "k" },
  { x: 71, y: 40, size: 34, o: 0.24, color: "#9D7BFF", dur: 7, delay: 0.2, type: "s" },
  ...
  { x: 89, y: 34, size: 20, o: 0.16, color: "#9D7BFF", dur: 5.6, delay: 1.9, type: "k" },
  ...
  { x: 54, y: 88, size: 22, o: 0.16, color: "#9D7BFF", dur: 6.6, delay: 0.5, type: "s" },
  { x: 11, y: 45, size: 16, o: 0.12, color: "#ffffff", dur: 5.9, delay: 1.7, type: "k" },
  { x: 96, y: 12, size: 24, o: 0.18, color: "#9D7BFF", dur: 6.1, delay: 0.3, type: "s" },
